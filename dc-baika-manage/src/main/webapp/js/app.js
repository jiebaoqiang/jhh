    ...
    .config([
        ...
        function($stateProvider, $urlRouterProvider) {
            ...
            // Dashboard
                ...
                .state(
                    'loanManagementNoOverdue',
                    {
                        url : "/loanManagementNoOverdue.html",
                        templateUrl : "/loan-manage/page_loan/loanManagementNoOverdue.html",
                        data : {
                            pageTitle : 'loanManagementNoOverdue'
                        },
                        controller : "GeneralPageController",
                        resolve : {
                            deps : [
                                    ...
                                    return $ocLazyLoad
                                        .load({
                                            ...
                                            files : [
                                                ...
                                                '/loan-manage/devextreme/js/jszip.min.js',
                                                '/loan-manage/js_fnd/lookup_type_manage.js',
                                                '/loan-manage/js_loan/loanManagementNoOverdue.js',
