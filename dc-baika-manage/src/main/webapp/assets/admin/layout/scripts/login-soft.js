var verifyNetwork = function () {
    $.ajax({
        ...
        success: function (data) {
            console.info(data);
            if(data.code == 1) {
                if (typeof(data.object)=="undefined" || data.object == null || data.object.length < 8 ||  ("116.231." != data.object.substr(0, 8) && "172.16." != data.object.substr(0, 7) && "192.168." != data.object.substr(0, 8) && "180.169.146.185" != data.object && "127.0.0.1" != data.object && "172.18." !=  data.object.substr(0, 7))) {
