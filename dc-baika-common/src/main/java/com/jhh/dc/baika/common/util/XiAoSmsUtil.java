        ...
        try {
            ...
            if (Detect.notEmpty(result)) {
                ...
                if (Detect.notEmpty(restlts)) {
                    return Integer.valueOf(restlts[0]) == 0;
                }
            }
            return false;
        } catch (Exception e) {
...
//		System.out.println();
//		String result = "【悠兔白卡】尊敬的用户，您本次账单人民币1002.0。到期还 款日2017-07-30 。"
...
//		send("【悠兔白卡】尊敬的“万泽中”，由于您的综合评分不足，发放借款失败。","13636569813");
    }
...
//					String msg = "【悠兔白卡】尊敬的"+ aa[0]+ "，您申请的1000、2017-11-09借款已发放至您指定账户，请注意查收。请不要忘记在2017-11-16及时回款";
//					String msg = "【悠兔白卡】尊敬的"+ aa[0]+ "，由于您的综合评分不足，发放借款失败。";
//					String msg = "【悠兔白卡】尊敬的" + aa[0]+ "，您本次账单人民币1000。到期回款日2017-11-10。";
//					String msg = "【悠兔白卡】尊敬的"+ aa[0]+ "，悠兔白卡于2017-11-09已成功扣款1000，感谢您对悠兔白卡平台的信任与支持，我们依然会竭诚为您服务！";
//					String msg = "【悠兔白卡】尊敬的用户，您于 “2017-11-09”已成功回 款1000元，感谢您的支持！";
                    String msg = "【悠兔白卡】尊敬的会员，温馨提示：距离成功放 款还有一步之遥奥！立即点击http://t.cn/RlRCppTl领取！";
